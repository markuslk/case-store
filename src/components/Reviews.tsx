...
export function ReviewGrid() {
	...
	return (
		<div ref={containerRef} className="relative lg:-mx-4 mt-16 grid h-[49rem] max-h-[150vh] grid-cols-1 items-start gap-8 overflow-hidden px-4 sm:mt-20 md:grid-cols-2 lg:grid-cols-3">
			{isInView ? (
				<>
					<ReviewColumn
...
export function Reviews() {
	return (
		<MaxWidthWrapper className="relative max-w-5xl">
			<h3 className="xl:hidden text-3xl md:text-4xl font-semibold p-1.5 bg-slate-900 text-white w-fit mx-auto">What people are buying</h3>
			<img aria-hidden="true" src="/what-people-are-buying.png" alt="decoration" className="absolute select-none hidden xl:block -left-32 top-1/3" />
			<ReviewGrid />
		</MaxWidthWrapper>
	);
}
